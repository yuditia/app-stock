...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit User - CV. Subur makmur</title>
                            ...
                            <div class="card-body">
                                ...
                                <form action="/user/{{ $user->id }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        aria-describedby="youtube" value="{{ $user->name }}">
                                    </div>
